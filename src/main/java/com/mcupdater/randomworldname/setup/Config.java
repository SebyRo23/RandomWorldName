...
public class Config {
    ...
    public static ModConfigSpec.ConfigValue<List<? extends String>> NOUNS;
    ...
    static {
        ...
        NOUNS = CLIENT_BUILDER.comment("List of nouns").defineList("nouns", Arrays.asList(
                "people",
                "history",
                "way",
                "art",
        ...
        PLACES = CLIENT_BUILDER.comment("List of places").defineList("places", Arrays.asList(
                "village",
                "town",
                "city",
                "metropolis",
